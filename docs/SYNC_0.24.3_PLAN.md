...
| **Project knowledge collections** | The Knowledge base is amputated; Intel Projects ships as instructions + memory + grouping (§4 Release 3). | Only if the Knowledge subsystem is ever revived on Intel — not currently planned. |
